...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'client.update': {
    roles: ['administrator', 'data-entry-operator', 'course-coordinator'],
    key: 'client-profile-updated',
    tenantPath: [],
    userPath: [],
  },
  'course.create': {
    roles: ['administrator', 'course-coordinator'],
    key: 'new-course-created',
    tenantPath: [],
    userPath: [],
  },
  'qualification.delete': {
    roles: ['administrator', 'data-entry-operator'],
    key: 'qualification-deleted',
    tenantPath: [],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'data-entry-operator', 'course-coordinator'];
