...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'data-entry-operator', 'course-coordinator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Addresses', path: '/addresses', entity: 'address', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
    { name: 'Courses', path: '/courses', entity: 'course', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Phones', path: '/phones', entity: 'phone', service: AccessServiceEnum.PROJECT, icon: FiPhone },
    {
      name: 'Qualifications',
      path: '/qualifications',
