        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              ...
              >
                <FormListItem label="Father Name" text={data?.father_name} />

                <FormListItem label="Qualification" text={data?.qualification} />

                <FormListItem label="Course To Join" text={data?.course_to_join} />

                <FormListItem label="Address" text={data?.address} />

                <FormListItem label="Phone Number" text={data?.phone_number} />

                <FormListItem label="Aadhar No" text={data?.aadhar_no} />
