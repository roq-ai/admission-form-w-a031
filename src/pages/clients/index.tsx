...
export function ClientListPage(props: ClientListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'father_name', header: 'Father Name', accessorKey: 'father_name' },
    { id: 'qualification', header: 'Qualification', accessorKey: 'qualification' },
    { id: 'course_to_join', header: 'Course To Join', accessorKey: 'course_to_join' },
    { id: 'address', header: 'Address', accessorKey: 'address' },
    { id: 'phone_number', header: 'Phone Number', accessorKey: 'phone_number' },
    { id: 'aadhar_no', header: 'Aadhar No', accessorKey: 'aadhar_no' },
