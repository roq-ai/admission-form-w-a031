    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper wrapperProps={{ mb: 3 }}>
          <ImagePicker ref={imageUploaderRef} onChange={handleImageChange} entity="client" entityId={id} />
        </FormWrapper>
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <TextInput
            error={formik.errors.course_to_join}
            label={'Course To Join'}
            props={{
              name: 'course_to_join',
              placeholder: 'Course To Join',
              value: formik.values?.course_to_join,
              onChange: formik.handleChange,
            }}
          />
